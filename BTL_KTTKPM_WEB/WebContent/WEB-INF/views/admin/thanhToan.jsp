...
<body>
	...
	<div class="container mt-4">
		<div class="row">
			...
			<div class="col-sm-7">
				<form action="${pageContext.request.contextPath }/admin/addThanhToan" method="Post">
				...
				<table class="table table-striped table-dark">
					...
					<tbody>
						<c:forEach items="${ds }" var="item">
							<tr>
								<td><input type="hidden" value="${item.idThanhToan }" name="idThanhToan" />
									${item.idThanhToan }</td>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title">Edit Thanh Toan</h4>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>

				<!-- Modal body -->
				<div class="modal-body">
					<form action="${pageContext.request.contextPath }/admin/updateThanhToan" method="POST">

						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-2 col-form-label">ID
							</label>
							<div class="col-sm-5">
								<input name="idThanhToan" id="idkl" value=""
	...
	<div class="modal fade" id="myModalDelete" role="dialog">
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<!-- Modal body -->
				<div class="modal-body">
					<form action="${pageContext.request.contextPath }/admin/deleteThanhToan" method="POST">

						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-2 col-form-label">ID
							</label>
							<div class="col-sm-5">
								<input name="idThanhToan" id="idklDelete" value=""
									placeholder="Id" class="form-control"
									readonly="readonly" />
							</div>
						</div>
