...
<body>
	...
	<div class="row">
		...
		<div class="col-sm-7">
			<form action="${pageContext.request.contextPath }/admin/updateSP" method="post" enctype="multipart/form-data">
				<div class="form-group row">
					<label for="inputEmail3" class="col-sm-2 col-form-label">ID</label>
					<div class="col-sm-10">
						<input name="idSanPham" class="form-control" placeholder="Id san pham" value="${sp.idSanPham }" readonly="readonly"/>
					</div>
				</div>
				<div class="form-group row">
					<label for="inputPassword3" class="col-sm-2 col-form-label">Ten </label>
					<div class="col-sm-10">
						<input name="tenSanPham" class="form-control" placeholder="Ten San Pham" value="${sp.tenSanPham }"/>
					</div>
				</div>
				<div class="form-group row">
					<label for="inputPassword3" class="col-sm-2 col-form-label">Mo Ta </label>
					<div class="col-sm-10">
						<input name="moTa" class="form-control" placeholder="Mo ta" value="${sp.moTa }"/>
					</div>
				</div>
				<div class="form-group row">
					<label for="inputPassword3" class="col-sm-2 col-form-label">So luong </label>
					<div class="col-sm-10">
						<input name="soLuong" class="form-control" placeholder="So luong san pham" value="${sp.soLuong }"/>
					</div>
				</div>
				<div class="form-group row">
					<label for="inputPassword3" class="col-sm-2 col-form-label">DOn gia </label>
					<div class="col-sm-10">
						<input name="donGia" class="form-control" placeholder="Don gia" value="${sp.donGia }"/>
					</div>
				</div>
				<div class="form-group row">
					<label for="inputPassword3" class="col-sm-2 col-form-label">Ngay San xuat </label>
					<div class="col-sm-10">
						<input name="ngaySanXuat" class="form-control" placeholder="Id san pham" type="Date" value="${sp.ngaySanXuat }"/>
					</div>
				</div>
				<div class="form-group row">
					<label for="inputPassword3" class="col-sm-2 col-form-label">Han Su Dung </label>
					<div class="col-sm-10">
						<input name="hanSuDung" class="form-control" placeholder="Han su Dung" type="Date" value="${sp.hanSuDung }"/>
					</div>
				</div>
				<div class="form-group row">
